...
public class PropertiesUtils {
    ...
    public String getPropertyValue(String propertyFileName, String key) {
        ...
        try {
            ...
            log.error("com.jingdianjichi.tool.PropertiesUtils.getPropertyValue.error:{}", e.getMessage(), e);
        }
        return "";
    }
    ...
    private void loadProperties(String shortPropertyFileName) throws URISyntaxException {
        ...
        try {
            ...
            log.error("com.jingdianjichi.tool.PropertiesUtils.loadProperties.error:{}", e.getMessage(), e);
        }
